...
describe('HordeApiService', () => {
  ...
  describe('getModelStatus', () => {
    it(
      'should fetch image model status',
      withDone((done) => {
  ...
  describe('getModelStats', () => {
    it(
      'should fetch image model stats',
      withDone((done) => {
  ...
  describe('getTotalStats', () => {
    it(
      'should fetch total image stats',
      withDone((done) => {
  ...
  describe('getWorkers', () => {
    ...
    it(
      ...
      withDone((done) => {
        ...
        const req = httpMock.expectOne(
          (request) =>
            request.url === `${baseUrl}/workers` && request.params.get('type') === 'text',
        );
    ...
    it(
      'should fetch all workers when no options provided',
      withDone((done) => {
        const mockWorkers = [
          {
            name: 'Worker1',
