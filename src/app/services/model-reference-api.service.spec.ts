...
describe('ModelReferenceApiService', () => {
  ...
  describe('getCategoryStatistics', () => {
    it(
      'should fetch category statistics successfully',
      withDone((done) => {
    ...
    it(
      'should pass group_text_models parameter when true',
      withDone((done) => {
    ...
    it(
      'should handle statistics with minimal data',
      withDone((done) => {
        const category = 'clip';
        const mockStatistics: CategoryStatistics = {
          category: 'clip',
  ...
  describe('getCategoryAudit', () => {
    ...
    it(
      'should pass preset parameter when provided',
      withDone((done) => {
        const category = 'image_generation';
    ...
    it(
      'should handle group_text_models and preset together',
      withDone((done) => {
        const category = 'text_generation';
    ...
    it(
      'should handle preset filtering with different presets',
      withDone((done) => {
        const category = 'image_generation';
  ...
  describe('error handling', () => {
    it(
      'should handle 404 errors gracefully for statistics',
      withDone((done) => {
    ...
    it(
      'should handle 500 errors gracefully for audit',
      withDone((done) => {
        const category = 'image_generation';
